const BIP39_WORDLIST = [
      ...
      "area", "arena", "argue", "arm", "armed", "army", "around", "arrange", "arrest", "arrive",
      ...
      "bundle", "burden", "burger", "burst", "bus", "business", "busy", "butter", "buyer", "buzz",
      ...
      "chronic", "chuckle", "chunk", "churn", "cider", "cigarette", "cinema", "circle", "citizen", "city",
      "civil", "claim", "clap", "clarify", "claw", "clay", "clean", "clerk", "clever", "click",
      "client", "cliff", "climb", "clinic", "clip", "clock", "clog", "close", "cloth", "cloud",
      "clown", "club", "clumsy", "cluster", "coach", "coal", "coast", "coconut", "code", "coffee",
      ...
      "dance", "danger", "daring", "dark", "dash", "data", "date", "daughter", "dawn", "day",
      ...
      "dispose", "distance", "divorce", "dizzy", "doctor", "document", "dog", "doll", "dolphin", "domain",
      ...
      "foam", "focus", "fog", "foil", "fold", "follow", "food", "foot", "forbid", "force",
      "forecast", "forest", "forget", "fork", "fortune", "forum", "forward", "fossil", "foster", "found",
      ...
      "gas", "gather", "gauge", "gaze", "general", "genius", "genre", "gentle", "genuine", "gesture",
      ...
      "laptop", "large", "later", "loss", "laugh", "laundry", "lava", "law", "lawn", "lawsuit",
      ...
      "pattern", "pause", "pave", "payment", "peace", "peanut", "pear", "peasant", "pebble", "pecan",
      "pedal", "penguin", "people", "pepper", "perfect", "permit", "person", "pet", "phone", "photo",
      ...
      "pyramid", "quality", "quantum", "quarter", "question", "quick", "quid", "quiet", "quit", "quiz",
      ...
      "strategy", "straw", "street", "strike", "strong", "struggle", "student", "stuff", "stumble", "style",
      ...
      "table", "tackle", "tag", "tail", "talent", "talk", "tall", "tank", "tap", "target",
      "task", "taste", "tattoo", "taxi", "teach", "team", "tell", "ten", "tenant", "tennis",
      "tent", "term", "test", "text", "thank", "that", "the", "their", "them", "theme",
      ...
      "vast", "vault", "vegetable", "vehicle", "velvet", "vendor", "venture", "venue", "verb", "verify",
      ...
      "wrap", "wreck", "wrestle", "wrist", "write", "wrong", "yard", "year", "yellow", "yes",
